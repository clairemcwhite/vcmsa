...
allscores_standard <- allscores %>%
  ...
  separate(experiment, into = c("tmp0", "tmp1", 'set', "tmp2", 'layers', 'model', 'padding', 'threshold', 'bc', 'rbh', '), sep = "_", extra = "merge", remove = FALSE) %>%
...
aln_evaluate_20_nopca_16layer_t5_padding10_thr70_nobc_mnc_oldclust
```



```{r}
allscores_standard %>% filter(experiment %in% c(""))
